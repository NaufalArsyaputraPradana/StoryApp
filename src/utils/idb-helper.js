export class IdbHelper {
  ...
  static async saveStories(stories) {
    ...
    return new Promise((resolve, reject) => {
      ...
      tx.onerror = (event) => reject(new Error('Gagal menyimpan stories ke IndexedDB'));
    });
  }
  ...
  static async getStories() {
    ...
    return new Promise((resolve, reject) => {
      request.onsuccess = () => resolve(request.result);
      request.onerror = (event) => reject(new Error('Gagal mengambil stories dari IndexedDB'));
    });
  }
  ...
  static async getStoryById(id) {
    ...
    return new Promise((resolve, reject) => {
      request.onsuccess = () => resolve(request.result);
      request.onerror = (event) => reject(new Error('Gagal mengambil story dari IndexedDB'));
    });
  }
  ...
  static async deleteStory(id) {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = (event) => reject(new Error(`Gagal menghapus story dengan id ${id} dari IndexedDB`));
    });
  }
  ...
  static async clearStories() {
    ...
    return new Promise((resolve, reject) => {
      request.onsuccess = () => resolve(true);
      request.onerror = (event) => reject(new Error('Gagal menghapus semua stories dari IndexedDB'));
    });
  }
  ...
  static async addToFavorites(story) {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => resolve(true);
      request.onerror = (event) => reject(new Error('Gagal menambahkan story ke favorit'));
    });
  }
  ...
  static async removeFromFavorites(id) {
    ...
    return new Promise((resolve, reject) => {
      const request = store.delete(id);
      request.onsuccess = () => resolve(true);
      request.onerror = (event) => reject(new Error('Gagal menghapus story dari favorit'));
    });
  }
  ...
  static async getFavorites() {
    ...
    return new Promise((resolve, reject) => {
      const request = store.getAll();
      request.onsuccess = () => resolve(request.result);
      request.onerror = (event) => reject(new Error('Gagal mengambil daftar favorit'));
    });
  }
  ...
  static async isFavorite(id) {
    ...
    return new Promise((resolve, reject) => {
      const request = store.get(id);
      request.onsuccess = () => resolve(!!request.result);
      request.onerror = (event) => reject(new Error('Gagal memeriksa status favorit'));
    });
  }
}